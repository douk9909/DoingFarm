...
export const faqContent = {
  ...
  items: [
    ...
    {
      id: 3,
      question: '[협업] 팀원을 초대하면 어떤 것을 함께 할 수 있나요?',
      answer:
    ...
    },
    {
      ...
      answer:
        '대시보드의 각 컬럼 밑에 할 일 카드를 추가하는 버튼[+]이 있습니다. \n해당 버튼을 클릭하면 할 일을 생성하는 모달이 뜨며 [+image upload] 버튼을 통해 사용자의 로컬 기기에 있는 사진을 선택할 수 있습니다. 등록된 사진은 카드의 썸네일로 노출되어, 어떤 작업인지 한눈에 파악하기 쉽게 도와줍니다.',
    },
    {
      id: 6,
      question: '[상태관리] 할 일의 상태(To-do, Done 등)는 어떻게 바꾸나요?',
      answer:
    ...
    {
      id: 7,
      question: '[대시보드] 자주 가는 대시보드를 고정하고 싶어요.',
      answer:
    ...
    {
      id: 8,
      question: '[필터링] 할 일이 너무 많은데, 특정 카드만 골라볼 수 있나요?',
      answer:
        '네, 강력한 필터링 기능을 활용해 보세요!\n\n [태그/담당자 필터]: 특정 태그가 붙은 카드나 내가 담당하고 있는 작업들만 모아볼 수 있습니다.\n\n수많은 할 일 속에서도 길을 잃지 않고, 지금 당장 집중해야 할 작업들만 쏙쏙 골라내어 대시보드를 효율적으로 관리해 보세요!',
    },
  ],
} as const;
